...
const RESOURCES = [
  "Case Studies", "Whitepapers", "Blog",
  "Webinars", "Documentation", "API Reference",
];
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 lg:gap-16">
          ...
          <div>
            ...
            <p className="text-sm text-gray-400 leading-relaxed mb-6 max-w-[240px]">
              Empowering teams to create winning proposals faster with intelligent AI tools designed for modern businesses.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="mailto:infoproposal.ai@.com" className="text-sm hover:text-white transition-colors">
                  infoproposal.ai@.com
                </a>
              </li>
