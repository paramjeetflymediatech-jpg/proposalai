  ...
  return (
    <>
      ...
      >
          ...
          <div className="w-1/2 flex flex-col justify-center px-10 lg:px-16 py-16">
            <AnimateOnScroll>
              ...
              <p className="text-gray-600 text-base lg:text-lg leading-relaxed max-w-md">
                <span className="font-bold text-dark">Client:</span> A re-insurance broker renowned for structuring complex programs for large cedents.
              </p>
            </AnimateOnScroll>
          </div>
        ...
        <div className="flex flex-col md:hidden relative px-6 pt-10 pb-12" style={{ zIndex: 1 }}>
          ...
          <div className="w-full h-52 mb-8">
            <img src="/case-study-2.png" alt="Insurance illustration" className="w-full h-full object-contain" />
          </div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 space-y-10">
        ...
        <AnimateOnScroll>
          <div className="bg-gray-50 rounded-2xl p-8 md:p-10">
            <h2 className="font-display text-2xl md:text-3xl font-bold text-primary mb-5">Solution: ProposalAI in Action</h2>
